...
// Misma URL que la página con el dropdown. El formulario hace POST con delegaciones=13 al cambiar.
...
export async function GET() {
  try {
    ...
    // Simular el submit del formulario: POST con delegaciones=13 (Cuauhtémoc).
    ...
    // Si SEDEMA no responde (timeout, red, etc.), devolvemos 200 con datos vacíos
    // para que la UI muestre "--" sin error en consola ni 502
    return NextResponse.json({
      index: undefined,
